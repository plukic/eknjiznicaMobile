...
public class BooksAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   private BooksContract.Presenter presenter;
    ...
    public BooksAdapter(RequestManager requestManager, DateAndTimeUtil dateAndTimeUtil, IBooksCallback callback, BooksContract.Presenter presenter) {
     ...
     class ViewHolder  extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        CardView cvParent;
         ...
         public void bind(BookOfferVM bookOfferVM){
            ...
            tvAddedToFavorites.setText(dateAndTimeUtil.FormatForAddedToFavorites(bookOfferVM.AddedToFavorites));
        }
